  ...
  this.reset = function reset() {
    return this.db.tx(function() {
      ...
      return Promise.all([
        ...
        return ctx.none("CREATE TABLE posts (id SERIAL PRIMARY KEY, user_id INTEGER REFERENCES users, timestamp TIMESTAMP, lat DECIMAL, lng DECIMAL, message TEXT, emotion TEXT, imageurl TEXT, location_name TEXT)");
      }).then(function() {
